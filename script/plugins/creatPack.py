...
def creatDataPackge(url='',method = "GET",header ={},data = {},cookie=''):
    cookies = dict(cookies_are=cookie)
    if method == "GET":
        r = requests.get(url=url, headers=header, params=data, cookies=cookies)
    elif method == "POST":
...
# r = requests.get('http://httpbin.org/post',headers=headers,params=payload)
# r =  creatDataPackge('http://httpbin.org/post',method='POST',header=headers,data=payload,cookie=None)
# for i in r.keys():
#     for j in r[i]:
#         print(j)